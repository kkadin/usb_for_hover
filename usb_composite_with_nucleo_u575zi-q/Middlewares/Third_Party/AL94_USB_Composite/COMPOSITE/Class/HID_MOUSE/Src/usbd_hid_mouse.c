...
//const uint8_t HID_Hover_ReportDescriptor[] = {
__ALIGN_BEGIN static uint8_t HID_Hover_ReportDescriptor[] = {
  ...
  case USB_REQ_TYPE_STANDARD:
    ...
    case USB_REQ_GET_DESCRIPTOR:
      if ((req->wValue >> 8) == HID_REPORT_DESC)
      {
        ...
        len = MIN(HID_HOVER_REPORT_DESC_SIZE, req->wLength);
        pbuf = HID_Hover_ReportDescriptor;
      }
